...
contract basicInfoGetter {
  ...
  /***  A note about gas and gasprice:
   ...
   startgas * gasprice huc are removed from the transaction sender's account.
  ...
  function getTxGasprice() public constant returns (uint) { // "gasprice" is the amount of gas the sender was *willing* to pay. 50000000 for me. (ghuc default)
    return tx.gasprice;
  }
