...
$ ghuc -h
  NAME:
     ghuc - the happyuc-go command line interface

     Copyright 2013-2017 The happyuc-go Authors

  USAGE:
     ghuc [options] command [command options] [arguments...]

  VERSION:
     1.7.3-unstable-9619a610

  COMMANDS:
     account     Manage accounts
     attach      Start an interactive JavaScript environment (connect to node)
     bug         opens a window to report a bug on the ghuc repo
  ...
  ETHASH OPTIONS:
    ...
    --ethash.dagdir "/home/mslinn/.ethash"  Directory to store the ethash mining DAGs (default = inside home folder)
